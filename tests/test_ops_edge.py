...
class TestComputeContentHash:
    def test_deterministic(self):
        lines = ["void fn() {\n", "    return;\n", "}\n"]
        h1 = _compute_content_hash(lines, 1, 4, "void fn()", "fn", "")
        h2 = _compute_content_hash(lines, 1, 4, "void fn()", "fn", "")
        assert h1 == h2
    ...
    def test_different_body_produces_different_hash(self):
        ...
        lines1 = ["line\n", "void a() { return 1; }\n", "line\n"]
        lines2 = ["line\n", "void a() { return 2; }\n", "line\n"]
        h1 = _compute_content_hash(lines1, 2, 3, "void a()", "a", "")
        h2 = _compute_content_hash(lines2, 2, 3, "void a()", "a", "")
        assert h1 != h2

    def test_different_signature_different_hash(self):
        lines = ["line\n", "void fn() { }\n", "line\n"]
        h1 = _compute_content_hash(lines, 2, 3, "void fn(int)", "fn", "")
        h2 = _compute_content_hash(lines, 2, 3, "void fn(char)", "fn", "")
        assert h1 != h2

    def test_different_docstring_different_hash(self):
        lines = ["line\n", "void fn() { }\n", "line\n"]
        h1 = _compute_content_hash(lines, 2, 3, "void fn()", "fn", "Doc A")
        h2 = _compute_content_hash(lines, 2, 3, "void fn()", "fn", "Doc B")
        assert h1 != h2

    def test_empty_body(self):
        lines: list[str] = []
        h = _compute_content_hash(lines, 2, 3, "void fn()", "fn", "")
        # end_line(3) > start_line(2) → True, 3 <= 0 → False → body ""
        assert len(h) == 64

    def test_null_signature_handled(self):
        lines = ["a\n", "void fn() { }\n"]
        h = _compute_content_hash(lines, 2, 3, "", "fn", "")
        assert len(h) == 64
    ...
    def test_whitespace_body_difference_detected(self):
        lines1 = ["a\n", "void fn() { return 1; }\n", "b\n"]
        lines2 = ["a\n", "void fn() {return 1;}\n", "b\n"]
        h1 = _compute_content_hash(lines1, 2, 3, "void fn()", "fn", "")
        h2 = _compute_content_hash(lines2, 2, 3, "void fn()", "fn", "")
    ...
    def test_trailing_whitespace_ignored(self):
        ...
        h1 = _compute_content_hash(lines1, 1, 2, "void fn()", "fn", "")
        h2 = _compute_content_hash(lines2, 1, 2, "void fn()", "fn", "")
    ...
    def test_invalid_range_for_body_read(self):
        ...
        lines = ["a\n"]
        h = _compute_content_hash(lines, 100, 200, "void fn()", "fn", "")
        assert len(h) == 64

    def test_end_line_equals_start_line(self):
        lines = ["void fn() { return; }\n"]
        h = _compute_content_hash(lines, 1, 1, "void fn()", "fn", "")
