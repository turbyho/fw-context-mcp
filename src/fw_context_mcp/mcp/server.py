...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "READING PAST THE FIRST PAGE — seven tools take an `offset` and lead\n"
        "with a page notice: lookup_symbol, search_bodies, search_content,\n"
        "find_callers, find_references, find_dead_code, find_hotspots.\n"
